...
public class SmokeTest extends BaseClass {
	...
	public void signuptest() throws InterruptedException{
		...
		lastname.sendKeys("Jirgale");
		email.sendKeys("vinay@ceinsys.com");
		...
		driver.findElement(By.name("email")).sendKeys("ritesh@ceinsys.com");
...
//		driver.findElement(By.id("login")).click();
		...
		WebElement userreject=driver.findElement(By.xpath("//div[text()='Vinay rejected successfully']"));
		...
		WebElement userapprove=driver.findElement(By.xpath("//div[text()='Ritesh approved successfully']"));
	...
	public void createproject() throws InterruptedException{
		...
		WebElement startat=driver.findElement(By.xpath("//button[text()='December 7th, 2023']"));
...
//		driver.findElement(By.xpath("//span[text()='Close']")).click();
		...
		WebElement newlayer=driver.findElement(By.xpath("//div[text()='Layer TestLayer created successfully']"));
